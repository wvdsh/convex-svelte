...
<div class="min-h-screen bg-gray-50">
	...
	<footer class="border-t border-gray-200 bg-white">
		<div class="mx-auto max-w-4xl px-4 py-4 text-center text-sm text-gray-500">
			<p>
				Visit <a href="https://svelte.dev" class="font-semibold text-gray-700 hover:text-gray-900">svelte.dev</a> to learn Svelte and
				<a href="https://docs.convex.dev" class="font-semibold text-gray-700 hover:text-gray-900">docs.convex.dev</a> to learn Convex
			</p>
		</div>
	</footer>
</div>
